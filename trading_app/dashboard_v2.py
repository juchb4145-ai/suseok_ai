...
def _setup_router_v3_summary(section: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "schema_version": section.get("schema_version", "setup_router_v3.observe.v4.1"),
        "feature_schema_version": section.get("feature_schema_version", "setup_router_v3.features.v4.1"),
        "router_version": section.get("router_version", "setup_router_v3.4.1"),
        "state_version": section.get("state_version", "setup_router_v3.state.v3.1"),
