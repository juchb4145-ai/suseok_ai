...
def _setup_router_v3_summary(section: dict[str, Any]) -> dict[str, Any]:
        ...
        rows.append(
            {
                ...
                "subscription_active": bool(item.get("subscription_active", False)),
                "subscription_sources": list(item.get("subscription_sources") or []),
                "subscription_budget_deferred": bool(item.get("subscription_budget_deferred", False)),
                "expansion_lease_required": bool(item.get("expansion_lease_required", False)),
    ...
    return {
        ...
        "readiness_evaluated_count": int(section.get("readiness_evaluated_count") or 0),
        "readiness_ready_count": int(section.get("readiness_ready_count") or 0),
        "readiness_wait_count": int(section.get("readiness_wait_count") or 0),
        "shape_evaluated_candidate_count": int(section.get("shape_evaluated_candidate_count") or 0),
        ...
        "readiness_status_counts": dict(section.get("readiness_status_counts") or {}),
        "readiness_funnel": dict(section.get("readiness_funnel") or {}),
        "subscription_requested_count": int(section.get("subscription_requested_count") or 0),
        "subscription_target_selected_count": int(section.get("subscription_target_selected_count") or 0),
        "market_action_unmapped_count": int(section.get("market_action_unmapped_count") or 0),
        "general_multisource_count": int(section.get("general_multisource_count") or 0),
        "general_multisource_expansion_ignored_count": int(section.get("general_multisource_expansion_ignored_count") or 0),
