...
def _setup_router_v3_summary(section: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "schema_version": section.get("schema_version", "setup_router_v3.observe.v2"),
        "feature_schema_version": section.get("feature_schema_version", "setup_router_v3.features.v2"),
        "router_version": section.get("router_version", "setup_router_v3.2"),
        "state_version": section.get("state_version", "setup_router_v3.state.v1"),
