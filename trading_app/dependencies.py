...
class CoreSettings:
    ...
    dry_run_commission_bp_per_side: float = 1.5
    dry_run_sell_tax_bp: float = 15.0
    dry_run_slippage_scenarios_bp: str = "0,10,20,30"
    dry_run_entry_delay_scenarios_sec: str = "0,1,3,5"
    dry_run_primary_slippage_bp: float = 10.0
    dry_run_primary_entry_delay_sec: int = 0
    dry_run_go_min_trade_days: int = 5
    dry_run_go_min_accepted_entry_lifecycles: int = 30
    dry_run_go_max_bad_ready_rate: float = 0.25
    dry_run_go_max_opportunity_loss_rate: float = 0.25
    dry_run_go_max_stale_tick_rate: float = 0.2
    dry_run_go_max_latency_distortion_rate: float = 0.2
    dry_run_stale_tick_age_sec: float = 3.0
    dry_run_gateway_latency_warn_ms: float = 1000.0
...
def get_settings() -> CoreSettings:
    ...
    return CoreSettings(
        ...
        dry_run_commission_bp_per_side=_float_env("TRADING_DRY_RUN_COMMISSION_BP_PER_SIDE", 1.5),
        dry_run_sell_tax_bp=_float_env("TRADING_DRY_RUN_SELL_TAX_BP", 15.0),
        dry_run_slippage_scenarios_bp=os.environ.get("TRADING_DRY_RUN_SLIPPAGE_SCENARIOS_BP", "0,10,20,30"),
        dry_run_entry_delay_scenarios_sec=os.environ.get("TRADING_DRY_RUN_ENTRY_DELAY_SCENARIOS_SEC", "0,1,3,5"),
        dry_run_primary_slippage_bp=_float_env("TRADING_DRY_RUN_PRIMARY_SLIPPAGE_BP", 10.0),
        dry_run_primary_entry_delay_sec=_int_env("TRADING_DRY_RUN_PRIMARY_ENTRY_DELAY_SEC", 0),
        dry_run_go_min_trade_days=_int_env("TRADING_DRY_RUN_GO_MIN_TRADE_DAYS", 5),
        dry_run_go_min_accepted_entry_lifecycles=_int_env("TRADING_DRY_RUN_GO_MIN_ACCEPTED_ENTRY_LIFECYCLES", 30),
        dry_run_go_max_bad_ready_rate=_float_env("TRADING_DRY_RUN_GO_MAX_BAD_READY_RATE", 0.25),
        dry_run_go_max_opportunity_loss_rate=_float_env("TRADING_DRY_RUN_GO_MAX_OPPORTUNITY_LOSS_RATE", 0.25),
        dry_run_go_max_stale_tick_rate=_float_env("TRADING_DRY_RUN_GO_MAX_STALE_TICK_RATE", 0.2),
        dry_run_go_max_latency_distortion_rate=_float_env("TRADING_DRY_RUN_GO_MAX_LATENCY_DISTORTION_RATE", 0.2),
        dry_run_stale_tick_age_sec=_float_env("TRADING_DRY_RUN_STALE_TICK_AGE_SEC", 3.0),
        dry_run_gateway_latency_warn_ms=_float_env("TRADING_DRY_RUN_GATEWAY_LATENCY_WARN_MS", 1000.0),
