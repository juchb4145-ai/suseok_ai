...
class ThemeSourceSyncService:
    ...
    def sync_source(self, source_name: str) -> ThemeSourceSyncResult:
    ...
    def _run_source(self, source: BaseThemeSource) -> ThemeSourceSyncResult:
        started_at = _now_text()
        theme_count = 0
        member_count = 0
        details = {"source": source.source_name}
        try:
