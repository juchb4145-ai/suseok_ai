...
class GatePipeline:
    ...
    def evaluate(
        ...
        *,
        ...
        leadership_results = {
            ...
            for result in StockLeadershipGate(self.theme_repository, self.market_data).evaluate_all(enriched_candidates)
        }
        market_gate = MarketIndexGate(self.market_index_store)
    ...
    def _evaluate_candidate_theme(
        ...
        final_score = _final_score(decisions)
        ...
        details = {
            ...
            "score_components": {
                "MarketIndexGate": market_decision.score * 0.15,
                "ThemeStrengthGate": theme_strength_decision.score * 0.30,
                "ThemePullbackGate": theme_pullback_decision.score * 0.15,
                "StockLeadershipGate": leadership_decision.score * 0.20,
                "StockPullbackEntryGate": stock_pullback_decision.score * 0.20,
            },
...
def _final_score(decisions: list[GateDecision]) -> float:
    weights = {
        "MarketIndexGate": 0.15,
        "ThemeStrengthGate": 0.30,
        "ThemePullbackGate": 0.15,
        "StockLeadershipGate": 0.20,
        "StockPullbackEntryGate": 0.20,
    }
...
def _final_grade(
    ...
    if final_score >= 70.0 and not temporary:
        return "B+", True, BlockType.NONE, False, 0, cap_rules, "PASS"
    if final_score >= 55.0 and not temporary:
        return "B", True, BlockType.NONE, False, 0, cap_rules, "PASS"
