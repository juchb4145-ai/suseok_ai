...
class StrategyRuntime:
    ...
    def _run_theme_board(self, snapshot: StrategyRuntimeSnapshot, now: datetime) -> None:
        if self.theme_board_pipeline is None:
            self._apply_theme_board_snapshot(snapshot)
            return
        try:
            summary = self.theme_board_pipeline.run_if_due(now)
            snapshot.theme_board = dict(summary or {})
            snapshot.warnings.extend(str(warning) for warning in list(summary.get("warnings") or []) if warning)
        except Exception as exc:
    ...
    def _apply_theme_board_snapshot(self, snapshot: StrategyRuntimeSnapshot) -> None:
        if snapshot.theme_board:
            return
        if self.theme_board_pipeline is not None:
            snapshot.theme_board = dict(getattr(self.theme_board_pipeline, "last_summary", {}) or {})
            if snapshot.theme_board:
                return
        try:
            snapshot.theme_board = theme_board_dashboard_section(self.db)
        except Exception as exc:
            snapshot.theme_board = {
                "status": "ERROR",
...
def _gate_result_record(result: GatePipelineResult, evaluated_at: str) -> dict:
    return {
        ...
        "display_status": result.details.get("display_status", result.details.get("sub_status", "")),
        "normalized_status": result.details.get("normalized_status", result.details.get("sub_status", "")),
        "display_status_source": result.details.get("display_status_source", ""),
        "display_status_reason": result.details.get("display_status_reason", ""),
        "lab_gate_status": result.details.get("lab_gate_status", ""),
        "final_gate_status": result.details.get("final_gate_status", result.details.get("sub_status", "")),
        "order_eligibility": result.details.get("order_eligibility", ""),
        "candidate_market": result.details.get("candidate_market", ""),
        "candidate_market_source": result.details.get("candidate_market_source", ""),
        "candidate_market_status": result.details.get("candidate_market_status", ""),
        "candidate_market_action": result.details.get("candidate_market_action", ""),
        "candidate_index_return_pct": result.details.get("candidate_index_return_pct"),
        "global_market_status": result.details.get("global_market_status", ""),
        "kospi_market_status": result.details.get("kospi_market_status", ""),
        "kosdaq_market_status": result.details.get("kosdaq_market_status", ""),
        "kospi_return_pct": result.details.get("kospi_return_pct"),
        "kosdaq_return_pct": result.details.get("kosdaq_return_pct"),
        "candidate_breadth_pct": result.details.get("candidate_breadth_pct"),
        "candidate_breadth_ready": bool(result.details.get("candidate_breadth_ready")),
        "candidate_breadth_sample_count": result.details.get("candidate_breadth_sample_count", 0),
        "candidate_breadth_source": result.details.get("candidate_breadth_source", ""),
        "candidate_valid_quote_ratio": result.details.get("candidate_valid_quote_ratio"),
        "candidate_breadth_trust_level": result.details.get("candidate_breadth_trust_level", ""),
        "candidate_breadth_gate_usable": bool(result.details.get("candidate_breadth_gate_usable")),
        "candidate_breadth_diagnostic_only": bool(result.details.get("candidate_breadth_diagnostic_only")),
        "candidate_market_raw_status": result.details.get("candidate_market_raw_status", ""),
        "candidate_market_confirmed_status": result.details.get("candidate_market_confirmed_status", ""),
        "candidate_market_confirmation_pending": bool(result.details.get("candidate_market_confirmation_pending")),
        "candidate_market_recovery_pending": bool(result.details.get("candidate_market_recovery_pending")),
        "market_side_weak_consecutive_cycles": result.details.get("market_side_weak_consecutive_cycles", 0),
        "market_side_risk_off_consecutive_cycles": result.details.get("market_side_risk_off_consecutive_cycles", 0),
        "market_side_healthy_consecutive_cycles": result.details.get("market_side_healthy_consecutive_cycles", 0),
        "market_side_wait_started_at": result.details.get("market_side_wait_started_at", ""),
        "market_side_cycle_id": result.details.get("market_side_cycle_id", ""),
        "market_side_last_confirmed_at": result.details.get("market_side_last_confirmed_at", ""),
        "market_side_last_recovered_at": result.details.get("market_side_last_recovered_at", ""),
        "market_side_recovered_at": result.details.get("market_side_recovered_at", ""),
        "market_side_cycles_to_recover": result.details.get("market_side_cycles_to_recover", 0),
        "market_side_recovered_to_ready": bool(result.details.get("market_side_recovered_to_ready")),
        "market_side_never_recovered": bool(result.details.get("market_side_never_recovered")),
        "market_side_blocked_buy_intent_count": result.details.get("market_side_blocked_buy_intent_count", 0),
        "market_side_recheck_after_sec": result.details.get("market_side_recheck_after_sec", 0),
        "market_confirmation_state_persisted": bool(result.details.get("market_confirmation_state_persisted")),
        "market_confirmation_state_restored": bool(result.details.get("market_confirmation_state_restored")),
        "market_confirmation_state_restore_reason": result.details.get("market_confirmation_state_restore_reason", ""),
        "market_confirmation_state_last_updated_at": result.details.get("market_confirmation_state_last_updated_at", ""),
        "market_confirmation_state_age_sec": result.details.get("market_confirmation_state_age_sec"),
        "market_confirmation_state_version": result.details.get("market_confirmation_state_version", 0),
        "market_confirmation_state_source": result.details.get("market_confirmation_state_source", ""),
        "market_confirmation_state_reset_reason": result.details.get("market_confirmation_state_reset_reason", ""),
        "market_confirmation_state_restore_skipped": bool(result.details.get("market_confirmation_state_restore_skipped")),
        "market_confirmation_state_max_restore_age_sec": result.details.get("market_confirmation_state_max_restore_age_sec", 0),
        "market_confirmation_state_expires_at": result.details.get("market_confirmation_state_expires_at", ""),
        "market_confirmation_state_reset_count": result.details.get("market_confirmation_state_reset_count", 0),
        "market_confirmation_transition_type": result.details.get("market_confirmation_transition_type", ""),
        "market_session_id": result.details.get("market_session_id", ""),
        "market_session_type": result.details.get("market_session_type", ""),
        "market_trade_date": result.details.get("market_trade_date", ""),
        "market_timezone": result.details.get("market_timezone", ""),
        "market_schedule_source": result.details.get("market_schedule_source", ""),
        "market_schedule_known": bool(result.details.get("market_schedule_known", True)),
        "market_is_regular_session": bool(result.details.get("market_is_regular_session", True)),
        "market_restore_allowed": bool(result.details.get("market_restore_allowed", True)),
        "market_reset_required": bool(result.details.get("market_reset_required", False)),
        "market_reset_reason": result.details.get("market_reset_reason", ""),
        "market_session_reason_codes": list(result.details.get("market_session_reason_codes") or []),
        "market_confirmation_metrics": dict(result.details.get("market_confirmation_metrics") or {}),
        "kospi_breadth_pct": result.details.get("kospi_breadth_pct"),
        "kosdaq_breadth_pct": result.details.get("kosdaq_breadth_pct"),
        "kospi_breadth_ready": bool(result.details.get("kospi_breadth_ready")),
        "kosdaq_breadth_ready": bool(result.details.get("kosdaq_breadth_ready")),
        "kospi_breadth_sample_count": result.details.get("kospi_breadth_sample_count", 0),
        "kosdaq_breadth_sample_count": result.details.get("kosdaq_breadth_sample_count", 0),
        "kospi_valid_quote_ratio": result.details.get("kospi_valid_quote_ratio"),
        "kosdaq_valid_quote_ratio": result.details.get("kosdaq_valid_quote_ratio"),
        "market_side_reason_codes": list(result.details.get("market_side_reason_codes") or []),
        "market_side_data_quality_flags": list(result.details.get("market_side_data_quality_flags") or []),
        "selected_support_source": result.details.get("selected_support_source", ""),
        "selected_support_price": result.details.get("selected_support_price"),
        "selected_support_ready": bool(result.details.get("selected_support_ready")),
        "selected_support_ready_reason": result.details.get("selected_support_ready_reason", ""),
        "support_ready": bool(result.details.get("support_ready")),
        ...
        **_realtime_reliability_record_fields(result),
        ...
        "recent_support_ready": bool(result.details.get("recent_support_ready")),
        "data_quality_bucket": result.details.get("data_quality_bucket", ""),
        "data_quality_action": result.details.get("data_quality_action", ""),
        "missing_core_fields": list(result.details.get("missing_core_fields") or []),
        "missing_entry_fields": list(result.details.get("missing_entry_fields") or []),
        "missing_optional_fields": list(result.details.get("missing_optional_fields") or []),
        "data_quality_confidence": result.details.get("data_quality_confidence", ""),
        "data_quality_operator_message_ko": result.details.get("data_quality_operator_message_ko", ""),
        "early_small_candidate": bool(result.details.get("early_small_candidate")),
        "early_small_order_enabled": bool(result.details.get("early_small_order_enabled")),
        "early_small_position_size_multiplier": result.details.get("early_small_position_size_multiplier"),
        "early_small_rejected_reason": result.details.get("early_small_rejected_reason", ""),
        ...
        "late_chase_temp_wait": bool(result.details.get("late_chase_temp_wait")),
        "late_chase_recoverable": bool(result.details.get("late_chase_recoverable")),
        ...
        "risk_off_max_position_size_multiplier": result.details.get("risk_off_max_position_size_multiplier"),
        "risk_off_exit_hint": dict(result.details.get("risk_off_exit_hint") or {}),
        "chase_risk": bool(result.details.get("chase_risk")),
        "chase_risk_reason": result.details.get("chase_risk_reason", ""),
        "price_location_block_reason": result.details.get("price_location_block_reason", ""),
        "market_wait_reason": result.details.get("market_wait_reason", ""),
