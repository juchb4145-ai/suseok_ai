...
class CandidateReasonCode(str, Enum):
    ...
    ORDER_MANAGER_OBSERVE_ONLY = "ORDER_MANAGER_OBSERVE_ONLY"
...
NEXT_REQUIRED_ACTION = {
    ...
    CandidateReasonCode.ORDER_RISK_REJECTED.value: "CHECK_ORDER_RISK",
    CandidateReasonCode.ORDER_MANAGER_OBSERVE_ONLY.value: "WAIT_ORDER_MANAGER_ENABLEMENT",
    CandidateReasonCode.RECONCILE_REQUIRED.value: "RECONCILE_ORDER_STATE",
    CandidateReasonCode.STOP_NEW_BUY.value: "WAIT_RISK_RECOVERY",
