...
| --- | --- | --- |
| `OPEN_ORDERS` | `opt10075` | `SYNTHETIC_ONLY` |
| `ACCOUNT_POSITIONS` | `opw00018` | `SYNTHETIC_ONLY` |
| `ACCOUNT_CASH` | `opw00001` | `SYNTHETIC_ONLY` |

KOA Studio 또는 실제 모의서버 capture로 필드명을 검증하기 전에는 PASS로 취급하지 않는다.
...
- `SYNTHETIC_ONLY`: 실제 모의서버 검증 전이므로 qualification은 HOLD다.
