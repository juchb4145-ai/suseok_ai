...
Cost, slippage, delay, and Go/No-Go settings:

- `TRADING_DRY_RUN_COMMISSION_BP_PER_SIDE` default `1.5`
- `TRADING_DRY_RUN_SELL_TAX_BP` default `15.0`
- `TRADING_DRY_RUN_SLIPPAGE_SCENARIOS_BP` default `0,10,20,30`
- `TRADING_DRY_RUN_ENTRY_DELAY_SCENARIOS_SEC` default `0,1,3,5`
- `TRADING_DRY_RUN_PRIMARY_SLIPPAGE_BP` default `10.0`
- `TRADING_DRY_RUN_PRIMARY_ENTRY_DELAY_SEC` default `0`
- `TRADING_DRY_RUN_GO_MIN_TRADE_DAYS` default `5`
- `TRADING_DRY_RUN_GO_MIN_ACCEPTED_ENTRY_LIFECYCLES` default `30`
- `TRADING_DRY_RUN_GO_MAX_BAD_READY_RATE` default `0.25`
- `TRADING_DRY_RUN_GO_MAX_OPPORTUNITY_LOSS_RATE` default `0.25`
- `TRADING_DRY_RUN_STALE_TICK_AGE_SEC` default `3.0`
- `TRADING_DRY_RUN_GATEWAY_LATENCY_WARN_MS` default `1000.0`
